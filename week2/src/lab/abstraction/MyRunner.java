...
//		System.out.println(sObj instanceof Circle); // we can not instantiate Abstract class
		
		System.out.println("--------------------");
		Shape shapeRectangleObj = new Rectangle("Red"); //UpCasting shapeRectangleObj.displayshapName();
...
//		System.out.println(sObj instanceof Rectangle); // we can not instantiate Abstract class
...
//		System.out.println(sObj instanceof Triangle); // we can not instantiate Abstract class
