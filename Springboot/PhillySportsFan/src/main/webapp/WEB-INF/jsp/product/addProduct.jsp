    ...
    <div class="col-5 container">
        <form action="/product/addProduct">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="productName" name="productName" aria-describedby="productNameHelp" value="${form.productName}">
            </div>
            <div class="mb-3">
                <label for="price" class="form-label">Price</label>
                <input type="number" class="form-control" id="price" name="vacationHours" aria-describedby="vacationHoursHelp" value="${form.vacationHours}">
            </div>
            <div class="mb-3">
